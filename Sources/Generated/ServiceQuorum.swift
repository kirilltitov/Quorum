/**
 * This file has been autogenerated by LGNC assembler on 2019-07-04 12:03:40.638973.
    ...
    enum DeleteComment: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let IDComment: Int? = try? self.extract(param: "IDComment", from: dictionary)
    ...
    enum Comments: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let token: String?? = try? self.extract(param: "token", from: dictionary, isOptional: true)
                ...
                let validatorFutures: [String: Future<Void>] = [
                    ...
                    "token": eventLoop.submit {
                        let _: String? = try self.extract(param: "token", from: dictionary, isOptional: true)
        ...
        public final class Response: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Response> {
                ...
                let comments: [Comment]? = try? self.extract(param: "comments", from: dictionary)
    ...
    enum PendingCommentsCount: Contract {
        ...
        public final class Response: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Response> {
                ...
                let count: Int? = try? self.extract(param: "count", from: dictionary)
