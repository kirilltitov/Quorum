/**
 * This file has been autogenerated by LGNC assembler on 2019-03-13 22:38:41.521135.
...
public extension Services {
    public struct Quorum: Service {
        ...
        private static func contractPendingComments(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        private static func contractHideComment(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        private static func contractUnhideComment(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        public static func checkContractsCallbacks() -> Bool {
            ...
            if self.contractPendingCommentsCallback == nil {
                LGNCore.log("Contract 'PendingComments' is not guaranteed")
                result = false
            }
            ...
            if self.contractHideCommentCallback == nil {
                LGNCore.log("Contract 'HideComment' is not guaranteed")
                result = false
            }

            if self.contractUnhideCommentCallback == nil {
                LGNCore.log("Contract 'UnhideComment' is not guaranteed")
                result = false
            }
...
public extension Services.Quorum.Contracts {
    ...
    public struct PendingComments: Contract {
        public typealias ParentService = Services.Quorum
    ...
    public struct HideComment: Contract {
        public typealias ParentService = Services.Quorum
    ...
    public struct UnhideComment: Contract {
        public typealias ParentService = Services.Quorum
