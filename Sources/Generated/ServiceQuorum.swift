/**
 * This file has been autogenerated by LGNC assembler on 2020-09-15 20:44:12 +0000 (1600202652.0171108).
...
public extension Services.Quorum.Contracts {
    ...
    enum HideComment: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, IDComment: Int) {
                self.token = token
    ...
    enum CreateComment: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, IDPost: String, IDReplyComment: Int? = nil, body: String) {
                self.token = token
                self.IDPost = IDPost
    ...
    enum Comments: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(IDPost: String, token: String? = nil) {
                self.IDPost = IDPost
                self.token = token
            }
    ...
    enum UpdateUserAccessLevel: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, IDUser: String, accessLevel: String) {
                self.token = token
                self.IDUser = IDUser
    ...
    enum EditComment: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, IDComment: Int, body: String) {
                self.token = token
                self.IDComment = IDComment
                self.body = body
            }
