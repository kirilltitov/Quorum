/**
 * This file has been autogenerated by LGNC assembler on 2019-06-19 23:47:25.269067.
...
public extension Services {
    struct Quorum: Service {
        ...
        public static let contractMap: Contract.Map = [
            ...
            Contracts.PendingCommentsCount.URI: (transports: Contracts.PendingCommentsCount.transports, executor: Quorum.contractPendingCommentsCount),
        ...
        private static var contractPendingCommentsCountCallback: Contracts.PendingCommentsCount.NormalizedCallback!
        ...
        public static func guaranteePendingCommentsCountContract(_ callback: @escaping Contracts.PendingCommentsCount.Callback) {
            self.contractPendingCommentsCountCallback = Contracts.PendingCommentsCount.normalize(callback: callback)
        }

        public static func guaranteePendingCommentsCountContract(_ callback: @escaping Contracts.PendingCommentsCount.NonFutureCallback) {
            self.guaranteePendingCommentsCountContract(Contracts.PendingCommentsCount.futurize(callback: callback))
        }
        ...
        public static func executePendingCommentsCountContract(
            at address: Address,
            with request: Contracts.PendingCommentsCount.Request,
            using client: LGNS.Client,
            controlBitmask: LGNP.Message.ControlBitmask = .defaultValues,
            uuid: UUID = UUID()
        ) -> Future<Contracts.PendingCommentsCount.Response> {
            return Contracts.PendingCommentsCount.execute(at: address, with: request, using: client, controlBitmask: controlBitmask, uuid: uuid)
        }
        ...
        private static func contractPendingCommentsCount(requestInfo: LGNCore.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
            return Contracts.PendingCommentsCount._invoke(with: self.contractPendingCommentsCountCallback, request: parsedDict, requestInfo: requestInfo, name: "PendingCommentsCount")
        }
        ...
        public static func checkContractsCallbacks() -> Bool {
            ...
            if self.contractPendingCommentsCountCallback == nil {
                Logger(label: "LGNC.Contracts.PendingCommentsCount").error("Contract 'PendingCommentsCount' is not guaranteed")
                result = false
            }
...
public extension Services.Quorum.Contracts {
    ...
    struct PendingCommentsCount: Contract {
        public typealias ParentService = Services.Quorum
        ...
        public static func guarantee(_ callback: @escaping Callback) {
            Services.Quorum.guaranteePendingCommentsCountContract(callback)
        }
