/**
 * This file has been autogenerated by LGNC assembler on 2019-11-09 16:56:35.500237.
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, context: LGNCore.Context) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    ...
                    "body": eventLoop.submit {
                        ...
                        if let error = Validation.Length.Max(length: 4000, message: "Comment must be less than {Length} characters long").validate(body!, context.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    }.flatMap {
