/**
 * This file has been autogenerated by LGNC assembler on 2019-07-02 22:48:44.579052.
...
public extension Services {
    enum Author: Service {
        ...
        public static func guaranteeCheckinContract(_ guaranteeClosure: @escaping Contracts.Checkin.Closure) {
        ...
        public static func guaranteePingContract(_ guaranteeClosure: @escaping Contracts.Ping.Closure) {
        ...
        public static func guaranteeRaiseEventContract(_ guaranteeClosure: @escaping Contracts.RaiseEvent.Closure) {
        ...
        public static func guaranteeAnnounceEventContract(_ guaranteeClosure: @escaping Contracts.AnnounceEvent.Closure) {
    ...
    enum Authenticate: Contract {
        ...
        public final class Response: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Response> {
                ...
                let IDUser: String?? = try? self.extract(param: "IDUser", from: dictionary, isOptional: true)

                let validatorFutures: [String: Future<Void>] = [
                    "IDUser": eventLoop.submit {
                        let _: String? = try self.extract(param: "IDUser", from: dictionary, isOptional: true)
    ...
    enum ValidateEmail: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let node: String? = try? self.extract(param: "node", from: dictionary)
                let validationToken: String? = try? self.extract(param: "validationToken", from: dictionary)
                let IDUser: String? = try? self.extract(param: "IDUser", from: dictionary)
    ...
    enum InternalSignup: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let userAgent: String? = try? self.extract(param: "userAgent", from: dictionary)
