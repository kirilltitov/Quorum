/**
 * This file has been autogenerated by LGNC assembler on 2020-10-03 10:48:38 +0000 (1601722118.370459).
    ...
    enum InternalLogin: Contract {
        ...
        public final class Response: ContractEntity {
            ...
            public static func initWithValidation(
                ...
                let session: String? = try? (self.extract(param: "session", from: dictionary) as String)
