/**
 * This file has been autogenerated by LGNC assembler on 2019-07-13 21:05:58.530833.
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    "node": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(node!, requestInfo.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
                    "validationToken": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(validationToken!, requestInfo.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    ...
                    "userAgent": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(userAgent!, requestInfo.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, requestInfo: LGNCore.RequestInfo) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    ...
                    "currentPassword": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(currentPassword!, requestInfo.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
