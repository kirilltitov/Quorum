/**
 * This file has been autogenerated by LGNC assembler on 2019-03-13 22:38:41.555736.
...
public extension Services {
    public struct Author: Service {
        ...
        private static func contractValidateEmail(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        private static func contractResendValidationEmail(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        private static func contractResetPasswordStep1(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        private static func contractResetPasswordStep2(requestInfo: LGNC.RequestInfo, parsedDict: Entita.Dict) -> Future<Entity> {
        ...
        public static func checkContractsCallbacks() -> Bool {
            ...
            if self.contractValidateEmailCallback == nil {
                LGNCore.log("Contract 'ValidateEmail' is not guaranteed")
                result = false
            }

            if self.contractResendValidationEmailCallback == nil {
                LGNCore.log("Contract 'ResendValidationEmail' is not guaranteed")
                result = false
            }

            if self.contractResetPasswordStep1Callback == nil {
                LGNCore.log("Contract 'ResetPasswordStep1' is not guaranteed")
                result = false
            }

            if self.contractResetPasswordStep2Callback == nil {
                LGNCore.log("Contract 'ResetPasswordStep2' is not guaranteed")
                result = false
            }
...
public extension Services.Author.Contracts {
    ...
    public struct Signup: Contract {
        ...
        public static let visibility: ContractVisibility = .Private
        public static let transports: [LGNC.Transport] = [.HTTP, .LGNS]
        public static let contentTypes: [Services.ContentType] = Services.ContentType.all
    ...
    public struct ValidateEmail: Contract {
        public typealias ParentService = Services.Author
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, on eventLoop: EventLoop) -> Future<Request> {
                ...
                do {
                    do {
                        ...
                        validatorFutures["node"]!.append(eventLoop.newSucceededFuture(result: ("node", Validation.Error.MissingValue())))
                    }
                    do {
    ...
    public struct ResendValidationEmail: Contract {
        public typealias ParentService = Services.Author
    ...
    public struct ResetPasswordStep1: Contract {
        public typealias ParentService = Services.Author
    ...
    public struct ResetPasswordStep2: Contract {
        public typealias ParentService = Services.Author
