/**
 * This file has been autogenerated by LGNC assembler on 2022-03-18 12:37:26 +0000 (1647607046.216601).
...
public extension Services {
    enum Author: Service {
        ...
        public static func guaranteeCheckinContract(_ guaranteeBody: @escaping Contracts.Checkin.GuaranteeBodyCanonical) {
            Contracts.Checkin.guaranteeCanonical(guaranteeBody)
        }
        ...
        public static func guaranteePingContract(_ guaranteeBody: @escaping Contracts.Ping.GuaranteeBodyCanonical) {
            Contracts.Ping.guaranteeCanonical(guaranteeBody)
        }
        ...
        public static func guaranteeRaiseEventContract(_ guaranteeBody: @escaping Contracts.RaiseEvent.GuaranteeBodyCanonical) {
            Contracts.RaiseEvent.guaranteeCanonical(guaranteeBody)
        }
        ...
        public static func guaranteeAnnounceEventContract(_ guaranteeBody: @escaping Contracts.AnnounceEvent.GuaranteeBodyCanonical) {
            Contracts.AnnounceEvent.guaranteeCanonical(guaranteeBody)
        }
...
public extension Services.Author.Contracts {
    ...
    enum Checkin: StructuredContract {
    ...
    enum RaiseEvent: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum AnnounceEvent: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum InternalLogin: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum UserInfoInternal: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum Authenticate: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum ValidateEmail: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum ResendValidationEmail: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum PasswordResetStep1: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum PasswordResetStep2: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum InternalSignup: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum Logout: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum PasswordChange: StructuredContract {
        public typealias ParentService = Services.Author
    ...
    enum Signup: StructuredContract {
        public typealias ParentService = Services.Author
