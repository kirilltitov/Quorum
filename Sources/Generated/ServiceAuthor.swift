/**
 * This file has been autogenerated by LGNC assembler on 2020-09-15 20:44:11 +0000 (1600202651.9735122).
...
public extension Services {
    enum Author: Service {
        ...
        public static func executeAnnounceEventContract(
            ...
            using client: LGNCClient
        ) -> EventLoopFuture<Contracts.AnnounceEvent.Response> {
        ...
        public static func executeRaiseEventContract(
            ...
            using client: LGNCClient
        ) -> EventLoopFuture<Contracts.RaiseEvent.Response> {
...
public extension Services.Author.Contracts {
    ...
    enum UpdateUserAccessLevel: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, portal: String, IDUser: String, accessLevel: String) {
                self.token = token
                self.portal = portal
                self.IDUser = IDUser
    ...
    enum Logout: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, portal: String) {
                self.token = token
                self.portal = portal
            }
    ...
    enum Authenticate: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            private static var validatorPortalClosure: Validation.CallbackWithAllowedValues<CallbackValidatorPortalAllowedValues>.Callback? = nil

            public enum CallbackValidatorPortalAllowedValues: String, CallbackWithAllowedValuesRepresentable, ValidatorErrorRepresentable {
                public typealias InputValue = String

                case TestError1 = "Test error #1"
                case errorTwo = "Test error #2"

                public func getErrorTuple() -> (message: String, code: Int) {
                    switch self {
                        case .TestError1: return (message: self.rawValue, code: 10001)
                        case .errorTwo: return (message: self.rawValue, code: 10002)
                    }
                }
            }
            ...
            public init(portal: String, token: String) {
                self.portal = portal
                self.token = token
            }
            ...
            public static func initWithValidation(
                ...
                let validatorFutures: [String: EventLoopFuture<Void>] = [
                    "portal": eventLoop
                        ...
                        .flatMap {
                            guard let validator = self.validatorPortalClosure else {
                                return eventLoop.makeSucceededFuture()
                            }
                            return Validation.CallbackWithAllowedValues<CallbackValidatorPortalAllowedValues>(callback: validator).validate(
                                portal!,
                                context.locale,
                                on: eventLoop
                            ).mapThrowing { maybeError in if let error = maybeError { throw error } }
            ...
            public static func validatePortal(
                _ callback: @escaping Validation.CallbackWithAllowedValues<CallbackValidatorPortalAllowedValues>.Callback
            ) {
                self.validatorPortalClosure = callback
            }
    ...
    enum PasswordChange: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public init(token: String, currentPassword: String, password1: String, password2: String) {
                self.token = token
            ...
            public static func initWithValidation(
                ...
                let token: String? = try? (self.extract(param: "token", from: dictionary) as String)
                let currentPassword: String? = try? (self.extract(param: "currentPassword", from: dictionary) as String)
                let password1: String? = try? (self.extract(param: "password1", from: dictionary) as String)
                let password2: String? = try? (self.extract(param: "password2", from: dictionary) as String)
                ...
                let validatorFutures: [String: EventLoopFuture<Void>] = [
                    ...
                    "currentPassword": eventLoop
                        .submit {
                            guard let _ = currentPassword else {
                                throw Validation.Error.MissingValue(context.locale)
                            }
                        },
                    "password1": eventLoop
