/**
 * This file has been autogenerated by LGNC assembler on 2019-12-19 13:59:44.356208.
...
public extension Services.Author.Contracts {
    ...
    enum UserInfo: Contract {
        ...
        public final class Request: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, context: LGNCore.Context) -> Future<Request> {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, context: LGNCore.Context) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    "node": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(node!, context.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
                    "validationToken": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(validationToken!, context.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
                    "IDUser": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(IDUser!, context.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, context: LGNCore.Context) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    ...
                    "userAgent": eventLoop.submit {
                        ...
                        if let error = Validation.NotEmpty().validate(userAgent!, context.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
        ...
        public final class Request: ContractEntity {
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, context: LGNCore.Context) -> Future<Request> {
                ...
                let validatorFutures: [String: Future<Void>] = [
                    ...
                    "currentPassword": eventLoop.submit {
                        guard let _ = currentPassword else {
                            throw Validation.Error.MissingValue(context.locale)
                        }
                    }.flatMap {
                        if let error = Validation.NotEmpty().validate(currentPassword!, context.locale) {
                            return eventLoop.makeFailedFuture(error)
                        }
                        return eventLoop.makeSucceededFuture()
                    },
