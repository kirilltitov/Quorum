...
func getMigrations() -> [() async throws -> Void] {
...
//    //        let _ = try Logic.Comment.likeOrUnlike(
//    //            comment: comment,
//    //            by: Models.User(ID: FDB.UUID(), username: "Kirill Titov", accessLevel: .Admin),
//    //            on: eventLoopGroup.eventLoop
//    //        ).wait()
//    //        let _ = try Logic.Comment.likeOrUnlike(
//    //            comment: comment,
...
//                else { return }
//                let transaction: any FDBTransaction = try App.current.fdb.begin()
